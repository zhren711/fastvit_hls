...
/* ZHR-92 descriptor-hoist, TERMINAL STATUS (2026-08-29) -- see
 * mac_array_deschoist.cpp's own identical header comment for the full
 * close-out writeup (mechanism confirmed correct -- csynth burst-read
 * count dropped 11->9 -- but closed anyway: real P&R failed timing,
 * WNS +0.021ns->-0.305ns, moving the critical path for the first time
 * across this whole exploration line onto a confirmed shared-multiplier
 * competition; board-measured latency came back UNCHANGED from the
 * deployed baseline, 3,608.56ms vs 3,608.76ms, inside noise). Duplicated
 * verbatim here, same discipline as every other file in this line. */
                       ...
                       hls::burst_maxi<ap_uint<32> > &in_burst)
{
    ...
    /* ZHR-92 line-A rescope (2026-08-29) -- see mac_array_deschoist.cpp's
     * own identical comment for the full rationale. */
