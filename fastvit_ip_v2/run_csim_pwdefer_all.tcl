...
open_project -reset pd_raster_csim
set_top mac_array_top
add_files mac_array.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
add_files -tb dw_raster_layer_tb.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
...
open_project -reset pd_wiring_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
add_files -tb mac_array_raster_integrated_wiring_tb.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
...
open_project -reset pd_elemwise_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DPW_DEFER_WRESP"
