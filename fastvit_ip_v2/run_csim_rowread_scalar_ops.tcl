...
# from tools/gen_rr_scalar_ops_csim_bundle.py). First-ever csim coverage of
# these four ops on this architecture.
open_project -reset rr_scalar_ops_csim
...
add_files -tb scalar_ops_real_desc_tb.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
