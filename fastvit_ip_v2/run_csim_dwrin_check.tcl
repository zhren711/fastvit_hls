...
open_project -reset dwrin_check_csim
set_top mac_array_top
add_files mac_array.cpp -cflags "-std=c++14 -DDWR_INPUT_BURST"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DDWR_INPUT_BURST"
add_files -tb dw_raster_layer_tb.cpp -cflags "-std=c++14 -DDWR_INPUT_BURST"
