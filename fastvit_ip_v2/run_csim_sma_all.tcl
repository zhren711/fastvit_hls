# run_csim_sma_all.tcl -- ZHR-92 (2026-09-12): SHARED_MUL_ARMS
...
open_project -reset sma_raster_csim
...
open_project -reset sma_wiring_csim
set_top mac_array_top
...
open_project -reset sma_elemwise_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14"
add_files dw_raster_layer.cpp -cflags "-std=c++14"
