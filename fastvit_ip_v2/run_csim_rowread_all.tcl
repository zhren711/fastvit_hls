...
open_project -reset rr_raster_csim
set_top mac_array_top
add_files mac_array.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
add_files -tb dw_raster_layer_tb.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
...
open_project -reset rr_wiring_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
add_files -tb mac_array_raster_integrated_wiring_tb.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
...
open_project -reset rr_elemwise_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DDWR_ROWREAD"
