...
# solution name (solution_baseline_check) to sidestep an external file lock on
...
open_solution "solution_baseline_check" -flow_target vivado
set_part $part
create_clock -period $clk_period -name default

csynth_design
puts ">>> Done. Report: ${proj_name}/solution_baseline_check/syn/report/mac_array_top_csynth.rpt"
exit
