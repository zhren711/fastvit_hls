# run_csynth_default_check9.tcl -- ZHR-92 (2026-09-15): flag-less build after the
# PW_WHOIST_WIDE + DWR_WBURST default flips -- csynth totals + hw.h must be
# bit-identical to the board-tested dwwb_export build (252/22/39,991/78,034).
set proj_name  "dflt9"
