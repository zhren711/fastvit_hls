...
# from tools/gen_rb2_scalar_ops_csim_bundle.py). First-ever csim coverage of
# these four ops on this architecture.
open_project -reset rb2_scalar_ops_csim
...
add_files -tb scalar_ops_real_desc_tb.cpp -cflags "-std=c++14 -DDWR_ROWBURST"
