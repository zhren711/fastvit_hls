...
# solution name (solution12) to sidestep an external file lock on
...
open_solution "solution12" -flow_target vivado
set_part $part
create_clock -period $clk_period -name default

csynth_design
puts ">>> Done. Report: ${proj_name}/solution12/syn/report/mac_array_top_csynth.rpt"
exit
