...
int main()
{
     ...
     * remainder path at stride=2 simultaneously. */
    {
        ...
        int s2_written[1] = {0};
        mac_array_top(s2, s2_feat.data(), s2_wbuf.data(), s2_bbuf.data(), s2_feat.data(), s2_written, reinterpret_cast<const ap_uint<32>*>(s2_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s2_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s2_feat.data())));
    ...
    mac_array_top(desc[0], feat.data(), wbuf.data(), bbuf.data(), feat.data(), &out_written[0], reinterpret_cast<const ap_uint<32>*>(feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat.data())));
    mac_array_top(desc[1], feat.data(), wbuf.data(), bbuf.data(), feat.data(), &out_written[1], reinterpret_cast<const ap_uint<32>*>(feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat.data())));
    ...
    mac_array_top(desc[0], feat2.data(), wbuf.data(), bbuf.data(), feat2.data(), &out_written2[0], reinterpret_cast<const ap_uint<32>*>(feat2.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat2.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat2.data())));
    mac_array_top(desc[1], feat2.data(), wbuf.data(), bbuf.data(), feat2.data(), &out_written2[1], reinterpret_cast<const ap_uint<32>*>(feat2.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat2.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(feat2.data())));
    ...
    bool phase3_ok = false;
    {
        ...
        int w3ritten[2] = {0, 0};
        mac_array_top(desc3[0], f3.data(), w3buf.data(), b3buf.data(), f3.data(), &w3ritten[0], reinterpret_cast<const ap_uint<32>*>(f3.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f3.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f3.data())));
        mac_array_top(desc3[1], f3.data(), w3buf.data(), b3buf.data(), f3.data(), &w3ritten[1], reinterpret_cast<const ap_uint<32>*>(f3.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f3.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f3.data())));
    ...
    bool phase4_ok = false;
    {
        ...
        mac_array_top(desc4[0], f4.data(), w4buf.data(), b4buf.data(), f4.data(), &w4ritten[0], reinterpret_cast<const ap_uint<32>*>(f4.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f4.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f4.data())));
        mac_array_top(desc4[1], f4.data(), w4buf.data(), b4buf.data(), f4.data(), &w4ritten[1], reinterpret_cast<const ap_uint<32>*>(f4.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f4.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f4.data())));
        mac_array_top(desc4[2], f4.data(), w4buf.data(), b4buf.data(), f4.data(), &w4ritten[2], reinterpret_cast<const ap_uint<32>*>(f4.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f4.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f4.data())));
    ...
    bool phase5_ok = false;
    {
        ...
        mac_array_top(desc5[0], f5.data(), w5buf.data(), b5buf.data(), f5.data(), &w5ritten[0], reinterpret_cast<const ap_uint<32>*>(f5.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5.data())));
        mac_array_top(desc5[1], f5.data(), w5buf.data(), b5buf.data(), f5.data(), &w5ritten[1], reinterpret_cast<const ap_uint<32>*>(f5.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5.data())));
        mac_array_top(desc5[2], f5.data(), w5buf.data(), b5buf.data(), f5.data(), &w5ritten[2], reinterpret_cast<const ap_uint<32>*>(f5.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5.data())));
        ...
        mac_array_top(desc5[0], f5b.data(), w5buf.data(), b5buf.data(), f5b.data(), &w5ritten_b[0], reinterpret_cast<const ap_uint<32>*>(f5b.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5b.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5b.data())));
        mac_array_top(desc5[1], f5b.data(), w5buf.data(), b5buf.data(), f5b.data(), &w5ritten_b[1], reinterpret_cast<const ap_uint<32>*>(f5b.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5b.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5b.data())));
        mac_array_top(desc5[2], f5b.data(), w5buf.data(), b5buf.data(), f5b.data(), &w5ritten_b[2], reinterpret_cast<const ap_uint<32>*>(f5b.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5b.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f5b.data())));
    ...
    bool phase6_ok = false;
    {
        ...
        mac_array_top(desc6[0], f6.data(), w6buf.data(), b6buf.data(), f6.data(), &w6ritten[0], reinterpret_cast<const ap_uint<32>*>(f6.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())));
        mac_array_top(desc6[1], f6.data(), w6buf.data(), b6buf.data(), f6.data(), &w6ritten[1], reinterpret_cast<const ap_uint<32>*>(f6.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())));
        mac_array_top(desc6[2], f6.data(), w6buf.data(), b6buf.data(), f6.data(), &w6ritten[2], reinterpret_cast<const ap_uint<32>*>(f6.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())));
        mac_array_top(desc6[3], f6.data(), w6buf.data(), b6buf.data(), f6.data(), &w6ritten[3], reinterpret_cast<const ap_uint<32>*>(f6.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())));
        mac_array_top(desc6[4], f6.data(), w6buf.data(), b6buf.data(), f6.data(), &w6ritten[4], reinterpret_cast<const ap_uint<32>*>(f6.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())));
        mac_array_top(desc6[5], f6.data(), w6buf.data(), b6buf.data(), f6.data(), &w6ritten[5], reinterpret_cast<const ap_uint<32>*>(f6.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f6.data())));
    ...
    bool phase7_ok = false;
    {
        ...
        int w7ritten[2] = {0, 0};
        mac_array_top(desc7[0], f7.data(), w7buf.data(), b7buf.data(), f7.data(), &w7ritten[0], reinterpret_cast<const ap_uint<32>*>(f7.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f7.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f7.data())));
        mac_array_top(desc7[1], f7.data(), w7buf.data(), b7buf.data(), f7.data(), &w7ritten[1], reinterpret_cast<const ap_uint<32>*>(f7.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f7.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f7.data())));
    ...
    bool phase8_ok = false;
    {
        ...
        int s8a_written[1] = {0};
        mac_array_top(desc8a, s8a_feat.data(), s8a_wbuf.data(), s8a_bbuf.data(), s8a_feat.data(), s8a_written, reinterpret_cast<const ap_uint<32>*>(s8a_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s8a_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s8a_feat.data())));
        ...
        int s8b_written[1] = {0};
        mac_array_top(desc8b, s8b_feat.data(), s8b_wbuf.data(), s8b_bbuf.data(), s8b_feat.data(), s8b_written, reinterpret_cast<const ap_uint<32>*>(s8b_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s8b_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s8b_feat.data())));
    ...
    bool phase9_ok = false;
    {
        ...
        int s9_written[1] = {0};
        mac_array_top(desc9, s9_feat.data(), s9_wbuf.data(), s9_bbuf.data(), s9_feat.data(), s9_written, reinterpret_cast<const ap_uint<32>*>(s9_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s9_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s9_feat.data())));
    ...
    bool phase10_ok = false;
    {
        ...
        mac_array_top(desc10[0], f10.data(), w10buf.data(), b10buf.data(), f10.data(), &w10ritten[0], reinterpret_cast<const ap_uint<32>*>(f10.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f10.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f10.data())));
        mac_array_top(desc10[1], f10.data(), w10buf.data(), b10buf.data(), f10.data(), &w10ritten[1], reinterpret_cast<const ap_uint<32>*>(f10.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f10.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f10.data())));
        mac_array_top(desc10[2], f10.data(), w10buf.data(), b10buf.data(), f10.data(), &w10ritten[2], reinterpret_cast<const ap_uint<32>*>(f10.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f10.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(f10.data())));
    ...
    bool phase11_ok = false;
    {
        ...
        int s11_written[1] = {0};
        mac_array_top(desc11, s11_feat.data(), s11_wbuf.data(), s11_bbuf.data(), s11_feat.data(), s11_written, reinterpret_cast<const ap_uint<32>*>(s11_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s11_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s11_feat.data())));
    ...
    bool phase12_ok = false;
    {
        ...
        int s12_written[1] = {0};
        mac_array_top(desc12, s12_feat.data(), s12_wbuf.data(), s12_bbuf.data(), s12_feat.data(), s12_written, reinterpret_cast<const ap_uint<32>*>(s12_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s12_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s12_feat.data())));
    ...
    bool phase13_ok = false;
    {
        ...
        int s13_written[1] = {0};
        mac_array_top(desc13, s13_feat.data(), s13_wbuf.data(), s13_bbuf.data(), s13_feat.data(), s13_written, reinterpret_cast<const ap_uint<32>*>(s13_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s13_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s13_feat.data())));
    ...
    bool phase14_ok = false;
    {
        ...
        int s14_written[1] = {0};
        mac_array_top(desc14, s14_feat.data(), s14_wbuf.data(), s14_bbuf.data(), s14_feat.data(), s14_written, reinterpret_cast<const ap_uint<32>*>(s14_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s14_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s14_feat.data())));
    ...
    bool phase15_ok = false;
    {
        ...
        int s15_written[1] = {0};
        mac_array_top(desc15, s15_feat.data(), s15_wbuf.data(), s15_bbuf.data(), s15_feat.data(), s15_written, reinterpret_cast<const ap_uint<32>*>(s15_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s15_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s15_feat.data())));
    ...
    bool phase16_ok = false;
    {
        ...
        int s16_written[1] = {0};
        mac_array_top(desc16, s16_feat.data(), s16_wbuf.data(), s16_bbuf.data(), s16_feat.data(), s16_written, reinterpret_cast<const ap_uint<32>*>(s16_feat.data()), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s16_feat.data())), hls::burst_maxi<ap_uint<32> >(reinterpret_cast<ap_uint<32>*>(s16_feat.data())));
