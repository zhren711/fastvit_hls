# run_csynth_default_check8.tcl -- ZHR-92 (2026-09-15): flag-less build after the
# SE_BURST default flip -- csynth totals + hw.h must be bit-identical to the
# board-tested seburst_export build (252/27/39,835/77,736).
set proj_name  "dflt8"
