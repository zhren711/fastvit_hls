# run_export_ip_ctr100.tcl -- ZHR-92 (2026-09-16): CTR_NARROW (the four loop-carried counter
# chains from the frequency sweep narrowed/folded; step-1 estimates 7.60/7.78/7.30/7.30 <= 8.5)
# on top of the deployed dwflat source, HLS create_clock at 10ns. Vivado side: run_impl_ctr100.tcl.
set proj_name  "ctr100_export"
