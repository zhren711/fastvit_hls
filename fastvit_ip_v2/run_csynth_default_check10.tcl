# run_csynth_default_check10.tcl -- ZHR-92 (2026-09-15): flag-less build after the
# PW_WRITEOUT_ROW default flip -- csynth totals + hw.h must be bit-identical to the
# board-tested worow_export build (252/22/39,475/79,042).
set proj_name  "dflt10"
