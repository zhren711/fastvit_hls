# run_csynth_default_check13.tcl -- ZHR-92 (2026-09-16): flag-less build with PW_DEFER_WRESP_KEEP_OTS=3
# (pop the ot three back). Judgment: PW_FLAT II=1 both instances, write/writeresp stages unchanged, Estimated unchanged.
