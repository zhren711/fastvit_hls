...
open_project -reset req2_raster_csim
set_top mac_array_top
add_files mac_array.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
add_files -tb dw_raster_layer_tb.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
...
open_project -reset req2_wiring_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
add_files -tb mac_array_raster_integrated_wiring_tb.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
...
open_project -reset req2_elemwise_csim
set_top mac_array_top
add_files mac_array_raster_integrated.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
add_files dw_raster_layer.cpp -cflags "-std=c++14 -DPW_ROWREAD_PLANE8 -DDWR_WBURST_PF"
