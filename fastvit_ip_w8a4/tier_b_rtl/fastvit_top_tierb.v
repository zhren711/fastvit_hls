...
module fastvit_top_tierb (
    ...
    output wire         m_axi_shared_gmem0_AWVALID,
    input  wire         m_axi_shared_gmem0_AWREADY,
    output wire [63:0]  m_axi_shared_gmem0_AWADDR,
    output wire [0:0]   m_axi_shared_gmem0_AWID,
    output wire [7:0]   m_axi_shared_gmem0_AWLEN,
    output wire [2:0]   m_axi_shared_gmem0_AWSIZE,
    output wire [1:0]   m_axi_shared_gmem0_AWBURST,
    output wire [1:0]   m_axi_shared_gmem0_AWLOCK,
    output wire [3:0]   m_axi_shared_gmem0_AWCACHE,
    output wire [2:0]   m_axi_shared_gmem0_AWPROT,
    output wire [3:0]   m_axi_shared_gmem0_AWQOS,
    output wire [3:0]   m_axi_shared_gmem0_AWREGION,
    output wire [0:0]   m_axi_shared_gmem0_AWUSER,
    output wire         m_axi_shared_gmem0_WVALID,
    input  wire         m_axi_shared_gmem0_WREADY,
    output wire [31:0]  m_axi_shared_gmem0_WDATA,
    output wire [3:0]   m_axi_shared_gmem0_WSTRB,
    output wire         m_axi_shared_gmem0_WLAST,
    output wire [0:0]   m_axi_shared_gmem0_WID,
    output wire [0:0]   m_axi_shared_gmem0_WUSER,
    output wire         m_axi_shared_gmem0_ARVALID,
    input  wire         m_axi_shared_gmem0_ARREADY,
    output wire [63:0]  m_axi_shared_gmem0_ARADDR,
    output wire [0:0]   m_axi_shared_gmem0_ARID,
    output wire [7:0]   m_axi_shared_gmem0_ARLEN,
    output wire [2:0]   m_axi_shared_gmem0_ARSIZE,
    output wire [1:0]   m_axi_shared_gmem0_ARBURST,
    output wire [1:0]   m_axi_shared_gmem0_ARLOCK,
    output wire [3:0]   m_axi_shared_gmem0_ARCACHE,
    output wire [2:0]   m_axi_shared_gmem0_ARPROT,
    output wire [3:0]   m_axi_shared_gmem0_ARQOS,
    output wire [3:0]   m_axi_shared_gmem0_ARREGION,
    output wire [0:0]   m_axi_shared_gmem0_ARUSER,
    input  wire         m_axi_shared_gmem0_RVALID,
    output wire         m_axi_shared_gmem0_RREADY,
    input  wire [31:0]  m_axi_shared_gmem0_RDATA,
    input  wire         m_axi_shared_gmem0_RLAST,
    input  wire [0:0]   m_axi_shared_gmem0_RID,
    input  wire [0:0]   m_axi_shared_gmem0_RUSER,
    input  wire [1:0]   m_axi_shared_gmem0_RRESP,
    input  wire         m_axi_shared_gmem0_BVALID,
    output wire         m_axi_shared_gmem0_BREADY,
    input  wire [1:0]   m_axi_shared_gmem0_BRESP,
    input  wire [0:0]   m_axi_shared_gmem0_BID,
    input  wire [0:0]   m_axi_shared_gmem0_BUSER,
    ...
    output wire         m_axi_shared_gmem3_AWVALID,
    input  wire         m_axi_shared_gmem3_AWREADY,
    output wire [63:0]  m_axi_shared_gmem3_AWADDR,
    output wire [0:0]   m_axi_shared_gmem3_AWID,
    output wire [7:0]   m_axi_shared_gmem3_AWLEN,
    output wire [2:0]   m_axi_shared_gmem3_AWSIZE,
    output wire [1:0]   m_axi_shared_gmem3_AWBURST,
    output wire [1:0]   m_axi_shared_gmem3_AWLOCK,
    output wire [3:0]   m_axi_shared_gmem3_AWCACHE,
    output wire [2:0]   m_axi_shared_gmem3_AWPROT,
    output wire [3:0]   m_axi_shared_gmem3_AWQOS,
    output wire [3:0]   m_axi_shared_gmem3_AWREGION,
    output wire [0:0]   m_axi_shared_gmem3_AWUSER,
    output wire         m_axi_shared_gmem3_WVALID,
    input  wire         m_axi_shared_gmem3_WREADY,
    output wire [31:0]  m_axi_shared_gmem3_WDATA,
    output wire [3:0]   m_axi_shared_gmem3_WSTRB,
    output wire         m_axi_shared_gmem3_WLAST,
    output wire [0:0]   m_axi_shared_gmem3_WID,
    output wire [0:0]   m_axi_shared_gmem3_WUSER,
    output wire         m_axi_shared_gmem3_ARVALID,
    input  wire         m_axi_shared_gmem3_ARREADY,
    output wire [63:0]  m_axi_shared_gmem3_ARADDR,
    output wire [0:0]   m_axi_shared_gmem3_ARID,
    output wire [7:0]   m_axi_shared_gmem3_ARLEN,
    output wire [2:0]   m_axi_shared_gmem3_ARSIZE,
    output wire [1:0]   m_axi_shared_gmem3_ARBURST,
    output wire [1:0]   m_axi_shared_gmem3_ARLOCK,
    output wire [3:0]   m_axi_shared_gmem3_ARCACHE,
    output wire [2:0]   m_axi_shared_gmem3_ARPROT,
    output wire [3:0]   m_axi_shared_gmem3_ARQOS,
    output wire [3:0]   m_axi_shared_gmem3_ARREGION,
    output wire [0:0]   m_axi_shared_gmem3_ARUSER,
    input  wire         m_axi_shared_gmem3_RVALID,
    output wire         m_axi_shared_gmem3_RREADY,
    input  wire [31:0]  m_axi_shared_gmem3_RDATA,
    input  wire         m_axi_shared_gmem3_RLAST,
    input  wire [0:0]   m_axi_shared_gmem3_RID,
    input  wire [0:0]   m_axi_shared_gmem3_RUSER,
    input  wire [1:0]   m_axi_shared_gmem3_RRESP,
    input  wire         m_axi_shared_gmem3_BVALID,
    output wire         m_axi_shared_gmem3_BREADY,
    input  wire [1:0]   m_axi_shared_gmem3_BRESP,
    input  wire [0:0]   m_axi_shared_gmem3_BID,
    input  wire [0:0]   m_axi_shared_gmem3_BUSER,
