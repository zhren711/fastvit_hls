...
// ==============================================================
`timescale 1ns/1ps
module fastvit_ip_control_s_axi
#(parameter
...
localparam
    ...
    ADDR_IN_A_DATA_1  = 6'h14,
    ADDR_IN_A_CTRL    = 6'h18,
    ADDR_IN_B_DATA_0  = 6'h1c,
    ADDR_IN_B_DATA_1  = 6'h20,
    ADDR_IN_B_CTRL    = 6'h24,
    ...
    if (ACLK_EN) begin
        if (ar_hs) begin
            ...
            case (raddr)
                ...
                ADDR_IN_A_DATA_1: begin
                    rdata <= int_in_a[63:32];
                end
...
always @(posedge ACLK) begin
    if (ARESET)
        ...
        if (w_hs && waddr == ADDR_IN_A_DATA_1)
            int_in_a[63:32] <= (WDATA[31:0] & wmask) | (int_in_a[63:32] & ~wmask);
    end
end
