// pwconv_only_top.v -- AUTO-EXTRACTED single-worker Tier B minimal harness.
// Isolates fastvit_ip_pwconv_worker (unmodified HLS black box) + its
...
module pwconv_only_top (
    ...
    output wire         m_axi_pwconv_gmem1_AWVALID,
    input  wire         m_axi_pwconv_gmem1_AWREADY,
    output wire [63:0]  m_axi_pwconv_gmem1_AWADDR,
    output wire [0:0]   m_axi_pwconv_gmem1_AWID,
    output wire [7:0]   m_axi_pwconv_gmem1_AWLEN,
    output wire [2:0]   m_axi_pwconv_gmem1_AWSIZE,
    output wire [1:0]   m_axi_pwconv_gmem1_AWBURST,
    output wire [1:0]   m_axi_pwconv_gmem1_AWLOCK,
    output wire [3:0]   m_axi_pwconv_gmem1_AWCACHE,
    output wire [2:0]   m_axi_pwconv_gmem1_AWPROT,
    output wire [3:0]   m_axi_pwconv_gmem1_AWQOS,
    output wire [3:0]   m_axi_pwconv_gmem1_AWREGION,
    output wire [0:0]   m_axi_pwconv_gmem1_AWUSER,
    output wire         m_axi_pwconv_gmem1_WVALID,
    input  wire         m_axi_pwconv_gmem1_WREADY,
    output wire [31:0]  m_axi_pwconv_gmem1_WDATA,
    output wire [3:0]   m_axi_pwconv_gmem1_WSTRB,
    output wire         m_axi_pwconv_gmem1_WLAST,
    output wire [0:0]   m_axi_pwconv_gmem1_WID,
    output wire [0:0]   m_axi_pwconv_gmem1_WUSER,
    output wire         m_axi_pwconv_gmem1_ARVALID,
    input  wire         m_axi_pwconv_gmem1_ARREADY,
    output wire [63:0]  m_axi_pwconv_gmem1_ARADDR,
    output wire [0:0]   m_axi_pwconv_gmem1_ARID,
    output wire [7:0]   m_axi_pwconv_gmem1_ARLEN,
    output wire [2:0]   m_axi_pwconv_gmem1_ARSIZE,
    output wire [1:0]   m_axi_pwconv_gmem1_ARBURST,
    output wire [1:0]   m_axi_pwconv_gmem1_ARLOCK,
    output wire [3:0]   m_axi_pwconv_gmem1_ARCACHE,
    output wire [2:0]   m_axi_pwconv_gmem1_ARPROT,
    output wire [3:0]   m_axi_pwconv_gmem1_ARQOS,
    output wire [3:0]   m_axi_pwconv_gmem1_ARREGION,
    output wire [0:0]   m_axi_pwconv_gmem1_ARUSER,
    input  wire         m_axi_pwconv_gmem1_RVALID,
    output wire         m_axi_pwconv_gmem1_RREADY,
    input  wire [31:0]  m_axi_pwconv_gmem1_RDATA,
    input  wire         m_axi_pwconv_gmem1_RLAST,
    input  wire [0:0]   m_axi_pwconv_gmem1_RID,
    input  wire [0:0]   m_axi_pwconv_gmem1_RUSER,
    input  wire [1:0]   m_axi_pwconv_gmem1_RRESP,
    input  wire         m_axi_pwconv_gmem1_BVALID,
    output wire         m_axi_pwconv_gmem1_BREADY,
    input  wire [1:0]   m_axi_pwconv_gmem1_BRESP,
    input  wire [0:0]   m_axi_pwconv_gmem1_BID,
    input  wire [0:0]   m_axi_pwconv_gmem1_BUSER,
    output wire         m_axi_pwconv_gmem2_AWVALID,
    input  wire         m_axi_pwconv_gmem2_AWREADY,
    output wire [63:0]  m_axi_pwconv_gmem2_AWADDR,
    output wire [0:0]   m_axi_pwconv_gmem2_AWID,
    output wire [7:0]   m_axi_pwconv_gmem2_AWLEN,
    output wire [2:0]   m_axi_pwconv_gmem2_AWSIZE,
    output wire [1:0]   m_axi_pwconv_gmem2_AWBURST,
    output wire [1:0]   m_axi_pwconv_gmem2_AWLOCK,
    output wire [3:0]   m_axi_pwconv_gmem2_AWCACHE,
    output wire [2:0]   m_axi_pwconv_gmem2_AWPROT,
    output wire [3:0]   m_axi_pwconv_gmem2_AWQOS,
    output wire [3:0]   m_axi_pwconv_gmem2_AWREGION,
    output wire [0:0]   m_axi_pwconv_gmem2_AWUSER,
    output wire         m_axi_pwconv_gmem2_WVALID,
    input  wire         m_axi_pwconv_gmem2_WREADY,
    output wire [31:0]  m_axi_pwconv_gmem2_WDATA,
    output wire [3:0]   m_axi_pwconv_gmem2_WSTRB,
    output wire         m_axi_pwconv_gmem2_WLAST,
    output wire [0:0]   m_axi_pwconv_gmem2_WID,
    output wire [0:0]   m_axi_pwconv_gmem2_WUSER,
    output wire         m_axi_pwconv_gmem2_ARVALID,
    input  wire         m_axi_pwconv_gmem2_ARREADY,
    output wire [63:0]  m_axi_pwconv_gmem2_ARADDR,
    output wire [0:0]   m_axi_pwconv_gmem2_ARID,
    output wire [7:0]   m_axi_pwconv_gmem2_ARLEN,
    output wire [2:0]   m_axi_pwconv_gmem2_ARSIZE,
    output wire [1:0]   m_axi_pwconv_gmem2_ARBURST,
    output wire [1:0]   m_axi_pwconv_gmem2_ARLOCK,
    output wire [3:0]   m_axi_pwconv_gmem2_ARCACHE,
    output wire [2:0]   m_axi_pwconv_gmem2_ARPROT,
    output wire [3:0]   m_axi_pwconv_gmem2_ARQOS,
    output wire [3:0]   m_axi_pwconv_gmem2_ARREGION,
    output wire [0:0]   m_axi_pwconv_gmem2_ARUSER,
    input  wire         m_axi_pwconv_gmem2_RVALID,
    output wire         m_axi_pwconv_gmem2_RREADY,
    input  wire [31:0]  m_axi_pwconv_gmem2_RDATA,
    input  wire         m_axi_pwconv_gmem2_RLAST,
    input  wire [0:0]   m_axi_pwconv_gmem2_RID,
    input  wire [0:0]   m_axi_pwconv_gmem2_RUSER,
    input  wire [1:0]   m_axi_pwconv_gmem2_RRESP,
    input  wire         m_axi_pwconv_gmem2_BVALID,
    output wire         m_axi_pwconv_gmem2_BREADY,
    input  wire [1:0]   m_axi_pwconv_gmem2_BRESP,
    input  wire [0:0]   m_axi_pwconv_gmem2_BID,
    input  wire [0:0]   m_axi_pwconv_gmem2_BUSER,
...
always @(posedge ap_clk) begin
    ...
    else if (busy_r && pwconv_worker_ap_done) busy_r <= 1'b0;
end

reg pwconv_start_hold;
always @(posedge ap_clk) begin
    if (ap_rst_n_inv) pwconv_start_hold <= 1'b0;
    else if (!busy_r && ap_start_lite)                      pwconv_start_hold <= 1'b1;
...
assign ap_done_o  = busy_r & pwconv_worker_ap_done;
...
pwconv_gmem2_m_axi_U (
    .AWVALID(m_axi_pwconv_gmem2_AWVALID), .AWREADY(m_axi_pwconv_gmem2_AWREADY), .AWADDR(m_axi_pwconv_gmem2_AWADDR),
    .AWID(m_axi_pwconv_gmem2_AWID), .AWLEN(m_axi_pwconv_gmem2_AWLEN), .AWSIZE(m_axi_pwconv_gmem2_AWSIZE),
    .AWBURST(m_axi_pwconv_gmem2_AWBURST), .AWLOCK(m_axi_pwconv_gmem2_AWLOCK), .AWCACHE(m_axi_pwconv_gmem2_AWCACHE),
    .AWPROT(m_axi_pwconv_gmem2_AWPROT), .AWQOS(m_axi_pwconv_gmem2_AWQOS), .AWREGION(m_axi_pwconv_gmem2_AWREGION), .AWUSER(m_axi_pwconv_gmem2_AWUSER),
    .WVALID(m_axi_pwconv_gmem2_WVALID), .WREADY(m_axi_pwconv_gmem2_WREADY), .WDATA(m_axi_pwconv_gmem2_WDATA),
    .WSTRB(m_axi_pwconv_gmem2_WSTRB), .WLAST(m_axi_pwconv_gmem2_WLAST), .WID(m_axi_pwconv_gmem2_WID), .WUSER(m_axi_pwconv_gmem2_WUSER),
    .ARVALID(m_axi_pwconv_gmem2_ARVALID), .ARREADY(m_axi_pwconv_gmem2_ARREADY), .ARADDR(m_axi_pwconv_gmem2_ARADDR),
    .ARID(m_axi_pwconv_gmem2_ARID), .ARLEN(m_axi_pwconv_gmem2_ARLEN), .ARSIZE(m_axi_pwconv_gmem2_ARSIZE),
    .ARBURST(m_axi_pwconv_gmem2_ARBURST), .ARLOCK(m_axi_pwconv_gmem2_ARLOCK), .ARCACHE(m_axi_pwconv_gmem2_ARCACHE),
    .ARPROT(m_axi_pwconv_gmem2_ARPROT), .ARQOS(m_axi_pwconv_gmem2_ARQOS), .ARREGION(m_axi_pwconv_gmem2_ARREGION), .ARUSER(m_axi_pwconv_gmem2_ARUSER),
    .RVALID(m_axi_pwconv_gmem2_RVALID), .RREADY(m_axi_pwconv_gmem2_RREADY), .RDATA(m_axi_pwconv_gmem2_RDATA),
    .RLAST(m_axi_pwconv_gmem2_RLAST), .RID(m_axi_pwconv_gmem2_RID), .RUSER(m_axi_pwconv_gmem2_RUSER), .RRESP(m_axi_pwconv_gmem2_RRESP),
    .BVALID(m_axi_pwconv_gmem2_BVALID), .BREADY(m_axi_pwconv_gmem2_BREADY), .BRESP(m_axi_pwconv_gmem2_BRESP),
    .BID(m_axi_pwconv_gmem2_BID), .BUSER(m_axi_pwconv_gmem2_BUSER),
    .ACLK(ap_clk), .ARESET(ap_rst_n_inv), .ACLK_EN(1'b1),
    .I_CH0_ARVALID(pwconv_g2_ARVALID), .I_CH0_ARREADY(pwconv_g2_ARREADY_i), .I_CH0_ARADDR(pwconv_g2_ARADDR), .I_CH0_ARLEN(pwconv_g2_ARLEN),
    .I_CH0_RVALID(pwconv_g2_RVALID_i), .I_CH0_RREADY(pwconv_g2_RREADY), .I_CH0_RDATA(pwconv_g2_RDATA_i), .I_CH0_RFIFONUM(pwconv_g2_RFIFONUM_i),
    .I_CH0_AWVALID(1'b0), .I_CH0_AWREADY(pwconv_g2_AWREADY_i), .I_CH0_AWADDR(64'd0), .I_CH0_AWLEN(32'd0),
    .I_CH0_WVALID(1'b0), .I_CH0_WREADY(pwconv_g2_WREADY_i), .I_CH0_WDATA(32'd0), .I_CH0_WSTRB(4'd0),
    .I_CH0_BVALID(pwconv_g2_BVALID_i), .I_CH0_BREADY(1'b0)
);
