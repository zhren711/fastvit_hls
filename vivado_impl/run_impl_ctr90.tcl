# run_impl_ctr90.tcl -- ZHR-92 (2026-09-16): real P&R for CTR_NARROW at 9.0ns / 111.111111MHz (HLS and
# Vivado retargeted together). route_design only, no phys_opt. Pre-registered: >= +0.05 counter chains were the ceiling / -0.1..+0.05 partly, next is the MAC accumulate chain / <= -0.1 not the ceiling.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "ctr90imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/ctr90_export/s1/impl/ip"
...
set_property -dict [list \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {111.111111} \
...
assign_bd_address
puts ">>> PS7 actual FCLK0: [get_property CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ [get_bd_cells ps7_0]] MHz"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_ctr90.rpt"
