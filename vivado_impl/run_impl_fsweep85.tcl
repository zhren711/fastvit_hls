# run_impl_fsweep85.tcl -- ZHR-92 (2026-09-16): frequency sweep point 8.5ns (117.647059MHz), HLS and
# Vivado retargeted together, deployed dwflat source. route_design only, no phys_opt, no board.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "fsweep85imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/fsweep85_export/s1/impl/ip"
...
set_property -dict [list \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {117.647059} \
...
open_run impl_1
set rpt_file "$proj_dir/utilization_fsweep85.rpt"
