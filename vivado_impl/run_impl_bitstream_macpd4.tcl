...
# run_impl_bitstream_pwchunk3.tcl. Short project name (macpd4imp) per this
# project's own Windows path-length precedent.

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "macpd4imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/macpd4/s1/impl/ip"
