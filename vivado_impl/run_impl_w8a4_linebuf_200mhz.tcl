...
set proj_name "fastvit_w8a4_linebuf_200mhz_proj"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_fastvit "$script_dir/../fastvit_ip_w8a4/fastvit_ip_w8a4_proj_200mhz/solution1/impl/ip"
...
create_bd_cell -type ip -vlnv user.org:hls:fastvit_ip:2.1 fastvit_ip_0
...
open_run impl_1
set rpt_file "$proj_dir/utilization_w8a4_200mhz.rpt"
