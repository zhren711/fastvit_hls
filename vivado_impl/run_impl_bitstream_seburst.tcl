# run_impl_bitstream_seburst.tcl -- ZHR-92 (2026-09-15): real P&R for SE_BURST on top
# of the deployed dwrow baseline (+0.211ns). Same BD, route_design only. Isolated LUT
# +1,929 (datapath: 4-lane SCALE + GAP read/sum) -- report the real delta.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "seburstimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/seburst_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_seburst.rpt"
