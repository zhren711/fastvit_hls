# run_impl_keep3_100.tcl -- ZHR-92 (2026-09-16): real P&R for the flag-less KEEP_OTS=3 build. route_design only.
# Pre-registered: WNS >= +0.190 (the preg100 build).
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "keep3_100imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/keep3_100_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_keep3_100.rpt"
