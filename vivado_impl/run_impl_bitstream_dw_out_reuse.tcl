# run_impl_bitstream_dw_out_reuse.tcl -- ZHR-92 (2026-09-12): real P&R
# for the DW_OUTPUT_BURST *port-reuse* build (dwr_writeout_packed writes
# through PW_FLAT's existing out_burst port instead of a 6th gmem_act
# port). Isolated csynth: CROW_CCOL II=2 preserved, LUT 72,639 (-128 vs
# the 6th-port build). Same BD topology as run_impl_bitstream_elemwise_
# burst.tcl (no new AXI master). Phase 1: route_design alone (phys_opt
# disabled), per the two-phase recipe. Pre-registered acceptance: store-
# unit FIFO width back to mem_reg[5][64] in the timing report, and WNS at
# least back to the baseline's own route_design-alone -0.167ns.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "dwoutreuseimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/dw_out_reuse_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_dw_out_reuse.rpt"
