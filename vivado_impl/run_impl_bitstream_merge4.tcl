# run_impl_bitstream_merge4.tcl -- ZHR-92 (2026-09-15): real P&R for
# PW_ROWREAD_MERGE4 on top of the deployed pwpf baseline. Same BD, route_design
# only (phys_opt separately if the violation is within -0.2ns). Isolated LUT
# +2,106 -- the largest delta on this line; report real LUT and the critical
# path (resource pressure on the route-dominated population vs new code).
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "merge4imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/merge4_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_merge4.rpt"
