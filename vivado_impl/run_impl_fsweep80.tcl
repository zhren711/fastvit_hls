# run_impl_fsweep80.tcl -- ZHR-92 (2026-09-16): frequency sweep point 8.0ns (125MHz), HLS and
# Vivado retargeted together, deployed dwflat source. route_design only, no phys_opt, no board.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "fsweep80imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/fsweep80_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_fsweep80.rpt"
