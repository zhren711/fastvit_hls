# run_impl_bitstream_flat.tcl -- ZHR-92 (2026-09-16): real P&R for DWR_FLAT on top of the
# deployed worow baseline (+0.285ns, 86.74% LUT). Same BD, route_design only. Isolated
# LUT +2,811 -- the real number is the first gate. Register map unchanged.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "flatimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/flat_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_flat.rpt"
