# run_impl_keep3_90.tcl -- ZHR-92 (2026-09-16): real P&R for the flag-less KEEP_OTS=3 build. route_design only.
# Pre-registered: 111MHz check, the preg90 build was +0.146.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "keep3_90imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/keep3_90_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_keep3_90.rpt"
