# run_impl_bitstream_dwrow.tcl -- ZHR-92 (2026-09-15): real P&R for
# DWR_ROW_PF + DWR_DEFER_WRESP on top of the deployed merge4 baseline (+0.461ns).
# Same BD, route_design only (phys_opt separately, only if the violation is
# within -0.2ns). Isolated LUT +626. Report real LUT and the critical path.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "dwrowimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/dwrow_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_dwrow.rpt"
