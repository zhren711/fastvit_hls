# run_impl_bitstream_macpd2.tcl -- ZHR-92 (2026-09-04): real P&R for
# the row-batched WRITEOUT mechanism. Same BD topology as
# run_impl_bitstream_pwchunk3.tcl. Short project name (macpd2imp) per this
# project's own Windows path-length precedent.

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "macpd2imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/macpd2/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_macpd2.rpt"
