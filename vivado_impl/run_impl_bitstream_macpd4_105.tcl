# run_impl_bitstream_macpd4.tcl -- ZHR-92 (2026-09-04): real P&R for
# the row-batched WRITEOUT mechanism. Same BD topology as
# run_impl_bitstream_pwchunk3.tcl. Short project name (macpd4f105imp) per this
# project's own Windows path-length precedent.

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "macpd4f105imp"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_macpd4.rpt"
