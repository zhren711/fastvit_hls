# run_impl_bitstream_dwob2.tcl -- ZHR-92 (2026-09-13): real P&R for the
# DW_OUTPUT_BURST re-test (port-reuse form) on top of SHARED_MUL_ARMS. The
# shared 32x32 multiplier sink that produced -0.418/-0.461 on both prior
# forms no longer exists. csim 4 suites clean; isolated LUT 72,090 (-1,418
# vs sma), CROW_CCOL II=2, register map unchanged. Same BD, route_design
# only. Judgment: WNS >= 0. If it fails and the critical path is one of the
# route-dominated population, the DW II win is unreachable at this
# placement density and the line closes.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "dwob2imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/dwob2_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_dwob2.rpt"
