# run_impl_macpd4_r8.tcl -- ZHR-92 150MHz re-check, point 1/3 (9.0ns/125MHz).
...
# see run_export_ip_macpd4_r8.tcl) AND the Vivado/PS7 clock (125MHz)
# tightened together -- the original 125/125/150MHz sweep never re-ran HLS
...
# deliverable build.
#
# 用法: vivado -mode batch -source run_impl_macpd4_r8.tcl -nolog -nojournal

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "macpd4r8imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/macpd4_r8/s1/impl/ip"
...
connect_bd_net $clk [get_bd_pins rst_ps7_0_125M/slowest_sync_clk]
...
set rstn [get_bd_pins rst_ps7_0_125M/peripheral_aresetn]
...
open_run impl_1
set rpt_file "$proj_dir/utilization_macpd4_r8.rpt"
report_utilization -file $rpt_file

set timing_rpt "$proj_dir/timing_detail_macpd4_r8.rpt"
report_timing -delay_type max -max_paths 10 -sort_by group -file $timing_rpt
puts ">>> Detailed timing report: $timing_rpt"
puts ""
puts "========================================"
puts " POST-ROUTE UTILIZATION (mac_array_top, MAC_PD=4, 9.0ns/125MHz)"
puts "========================================"
report_utilization
