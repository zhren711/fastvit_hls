# run_impl_bitstream_pwchunk3.tcl -- ZHR-92 (2026-09-03): real P&R for the
# THIRD fix (total_iters hoisted out of pw_flat_pipeline_impl into
# run_layer's own PW_WCHUNK loop) to the chunked PW weight-loading
# regression. Same BD topology as run_impl_bitstream_pw_weight_hoist.tcl (3
# masters, no pblock, route_design only, no phys_opt). Short project name
# (pwc3imp) per this project's own Windows path-length precedent.

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "pwc3imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/pwchunk3/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_pwchunk3.rpt"
