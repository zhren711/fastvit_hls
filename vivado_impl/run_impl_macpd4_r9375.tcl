# run_impl_macpd4_r9375.tcl -- ZHR-92 150MHz re-check, point 1/3 (9.375ns/106.667MHz (config 105)).
...
# see run_export_ip_macpd4_r9375.tcl) AND the Vivado/PS7 clock (111MHz)
# tightened together -- the original 111/125/150MHz sweep never re-ran HLS
...
# deliverable build.
#
# 用法: vivado -mode batch -source run_impl_macpd4_r9375.tcl -nolog -nojournal

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "macpd4r9375imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/macpd4_r9375/s1/impl/ip"
...
set_property -dict [list \
    ...
    CONFIG.PCW_FPGA0_PERIPHERAL_FREQMHZ {105} \
...
create_bd_cell -type ip -vlnv xilinx.com:ip:proc_sys_reset:5.0 rst_ps7_0_105M
...
connect_bd_net $clk [get_bd_pins rst_ps7_0_105M/slowest_sync_clk]
...
connect_bd_net [get_bd_pins ps7_0/FCLK_RESET0_N] \
               [get_bd_pins rst_ps7_0_105M/ext_reset_in]
set rstn [get_bd_pins rst_ps7_0_105M/peripheral_aresetn]
...
open_run impl_1
set rpt_file "$proj_dir/utilization_macpd4_r9375.rpt"
report_utilization -file $rpt_file

set timing_rpt "$proj_dir/timing_detail_macpd4_r9375.rpt"
report_timing -delay_type max -max_paths 10 -sort_by group -file $timing_rpt
puts ">>> Detailed timing report: $timing_rpt"
puts ""
puts "========================================"
puts " POST-ROUTE UTILIZATION (mac_array_top, MAC_PD=4, 9.375ns/106.667MHz (config 105))"
puts "========================================"
report_utilization
