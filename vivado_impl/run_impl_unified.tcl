...
set proj_name "fastvit_unified_proj"
...
create_bd_cell -type ip -vlnv user.org:hls:fastvit_ip:1.2 fastvit_ip_0
...
open_run impl_1
set rpt_file "$proj_dir/utilization_unified.rpt"
