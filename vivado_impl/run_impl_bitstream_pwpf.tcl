# run_impl_bitstream_pwpf.tcl -- ZHR-92 (2026-09-15): real P&R for
# PW_ROWREAD_PREFETCH (ROW_READ requests 8 channels ahead) on top of the
# deployed pwdefer baseline. Same BD, route_design only. Judgment: WNS >= 0
# (current +0.292); real LUT vs isolated +722.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "pwpfimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/pwpf_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_pwpf.rpt"
