...
set proj_name "a3wp21b"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/mac_array_poc_a3_axi/solution21/impl/ip"
...
# (2026-08-23, ZHR-92, MERGE round: gmem_act_wide is GONE -- in_base_wide
# now shares bundle=gmem_act with in_base/out_base, back to 4 masters,
# NUM_SI reverted 5->4.)
