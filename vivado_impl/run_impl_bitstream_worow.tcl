# run_impl_bitstream_worow.tcl -- ZHR-92 (2026-09-15): real P&R for PW_WRITEOUT_ROW on top
# of the deployed wburst baseline (+0.180ns, 87.15% LUT). Same BD, route_design only.
# Isolated LUT +1,008 (4 clip_shift lanes -- datapath). Register map unchanged.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "worowimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/worow_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_worow.rpt"
