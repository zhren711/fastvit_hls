# run_impl_bitstream_dwwb.tcl -- ZHR-92 (2026-09-15): real P&R for PW_WHOIST_WIDE +
# DWR_WBURST on top of the deployed seburst baseline. Same BD, route_design only.
# Isolated LUT +298 vs seburst (-24 vs whoist), DSP -5. Register map == whoist.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "dwwbimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/dwwb_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_dwwb.rpt"
