# run_impl_mac_array_a3_sol35_burstwriteout.tcl -- ZHR-92 angle-B
# WRITEOUT hls::burst_maxi dual-path P&R (2026-08-24). Same 4-master
# BD/SmartConnect topology as sol26_pwflat_wide (out_burst shares
# bundle=gmem_act, not a 5th master), same X0-120 pblock as the last
# successful PW-flat round -- LUT only grew 52,060->52,646 (+1.1%) from
# that round, well under the scale that previously required a pblock
# resize (CLAUDE.md's own re-check rule). One shot; if this fails to
# route, STOP and report, do not try a second size blind.
#
# 用法: vivado -mode batch -source run_impl_mac_array_a3_sol35_burstwriteout.tcl -nolog -nojournal

set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "a3wp26"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/mac_array_poc_a3_axi/solution35/impl/ip"
...
# ── pblock (X0-120, same as the last successful PW-flat round) ──
...
puts ""
puts "========================================"
puts " POST-ROUTE UTILIZATION (mac_array_top, WRITEOUT burst_maxi dual-path)"
puts "========================================"
report_utilization
