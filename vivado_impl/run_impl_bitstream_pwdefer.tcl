# run_impl_bitstream_pwdefer.tcl -- ZHR-92 (2026-09-15): real P&R for
# PW_DEFER_WRESP (PW_FLAT write_response deferred two ots; request+write
# unchanged inside the II=1 pipeline) on top of the deployed rowread
# baseline. Same BD, route_design only (phys_opt allowed separately if the
# violation is within -0.2ns). Judgment: WNS >= 0 (current +0.113); real LUT
# vs isolated +480.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "pwdeferimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/pwdefer_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_pwdefer.rpt"
