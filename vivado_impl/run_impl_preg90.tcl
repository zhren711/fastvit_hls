# run_impl_preg90.tcl -- ZHR-92 (2026-09-16): real P&R for CTR_NARROW + PW_MAC_PREG + PW_ACC_NARROW (layer 2).
# route_design only, no phys_opt. Pre-registered: >= +0.05 111MHz unlocked / -0.1..+0.05 close, read the new #1 / <= -0.1 the product register did not split the critical segment.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "preg90imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/preg90_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_preg90.rpt"
