# run_impl_bitstream_rowread.tcl -- ZHR-92 (2026-09-14): real P&R for
# DWR_ROWREAD (row-granularity input read_request outside the COL loop,
# word-packed read() inside; COL II=1, iter latency 12->3; zero II
# violations design-wide) on top of the deployed rowburst baseline. Same BD,
# route_design only. Judgment: WNS >= 0 (current +0.312); report the critical
# path (last round's worst was gmem_w load buffer -> DW gather, and this round
# changes DW's input read); real LUT vs isolated -1,005.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "rowreadimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/rowread_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_rowread.rpt"
