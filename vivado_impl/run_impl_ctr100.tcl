# run_impl_ctr100.tcl -- ZHR-92 (2026-09-16): real P&R for CTR_NARROW at 10ns / 100MHz (HLS and
# Vivado retargeted together). route_design only, no phys_opt. Pre-registered: must not regress from dwflat's +0.135 (a placement roll of +-0.3 is the norm; <= -0.3 -> stop and read the critical path).
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "ctr100imp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/ctr100_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_ctr100.rpt"
