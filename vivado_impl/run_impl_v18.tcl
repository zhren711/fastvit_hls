...
set proj_name "fastvit_v18_proj"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_fastvit "$script_dir/../fastvit_ip/fastvit_ip_proj_v18/solution1/impl/ip"
...
create_bd_cell -type ip -vlnv user.org:hls:fastvit_ip:1.8 fastvit_ip_0
...
open_run impl_1
set rpt_file "$proj_dir/utilization_v18.rpt"
report_utilization -file $rpt_file

set timing_rpt "$proj_dir/timing_detail_v18.rpt"
report_timing -delay_type max -max_paths 10 -sort_by group -file $timing_rpt
puts ">>> Detailed timing report: $timing_rpt"
puts ""
puts "========================================"
puts " POST-IMPLEMENTATION UTILIZATION (v1.8, grouped masters, 2 HP ports, 100MHz)"
puts "========================================"
report_utilization
