# run_impl_bitstream_whoist.tcl -- ZHR-92 (2026-09-15): real P&R for PW_WHOIST_WIDE on
# top of the deployed seburst baseline (+0.254ns). Same BD, route_design only.
# Isolated LUT +322 (control-only). New register 0x10c/0x110.
set_param general.maxThreads 1

set part      "xc7z020clg400-1"
set proj_name "whoistimp"
set script_dir [file normalize [file dirname [info script]]]
set proj_dir   "$script_dir/$proj_name"

set ip_mac_array "$script_dir/../fastvit_ip_v2/whoist_export/s1/impl/ip"
...
open_run impl_1
set rpt_file "$proj_dir/utilization_whoist.rpt"
