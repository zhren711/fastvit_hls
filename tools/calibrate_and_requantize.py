...
def parse_args():
    ...
    p.add_argument("--out", default=r"E:\codes\microzed\fastvit_hls\weights_t8_calibrated")
...
def classify_conv_edges(graph, conv_nodes, init_names):
...
def main():
    ...
    roles = classify_conv_edges(graph, conv_nodes, init_names)
