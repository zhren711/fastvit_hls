#================================================================
# run_hls_v11.tcl — dwconv_ip v11.0 (32-bit packed DDR access)
# 目标: MicroZed xc7z020clg400-1
# 用法: vitis_hls -f run_hls_v11.tcl
#================================================================
...
puts ">>> Running C Synthesis (32-bit packed DDR v11.0)..."
csynth_design

puts ">>> Exporting IP v11.0..."
export_design -format ip_catalog \
              -display_name "FastVIT_DWConv_IP" \
              -description  "DW Conv v11 32-bit packed DDR, K=3/7, xc7z020" \
              -vendor        "user.org" \
              -version       "11.0"
